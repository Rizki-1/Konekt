                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="sub-drop dropdown-menu dropdown-menu-end p-0"
                                    ...
                                    <div class="card shadow-none m-0">
                                        ...
                                        @php
                                            $latestNotifications = $notifikasipenjual->sortByDesc('created_at')->take(3);
                                        @endphp

                                        @forelse ($latestNotifications as $notif)
                                            <div class="card-body p-0">
                                                <a href="{{ route('pesananpenjual') }}" class="iq-sub-card"
                                                    data-notification-id="{{ $notif->id }}">
                                                    <div class="d-flex text-align-center">
                                                        <div class="w-100">
                                                            <h6 class="mb-0">{{ $notif->keterangan_penjual }}</h6>
                                    ...
                                    <script>
                                        function updateNotificationCount() {
                                            ...
                                            $.ajax({
                                                url: "{{ route('notifikasipenjual') }}", // Ganti dengan URL yang sesuai di server
                                                method: 'GET',
                                        ...
                                        $('.iq-sub-card').click(function() {
                                            ...
                                            $.ajax({
                                                url: 'readnotifikasipenjual/' + notificationId,
                                                type: 'POST',
                                                headers: {
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="59" height="58"
                                    ...
                                    <g clip-path="url(#clip0_1953_6020)">
                                        <mask id="mask0_1953_6020" style="mask-type:luminance"
                                            maskUnits="userSpaceOnUse" x="0" y="0" width="59"
                                            height="58">
                                            <path d="M58.79 0.0351562H0.869995V57.9552H58.79V0.0351562Z"
                                                fill="white" />
                                        </mask>
                                        <g mask="url(#mask0_1953_6020)">
                                            <path
                                                d="M20.7882 14.064C20.6867 14.1109 20.5304 14.2047 20.4445 14.2751C20.218 14.4783 15.203 22.0371 15.1014 22.3342C14.9687 22.7016 14.9687 46.6991 15.0936 47.1603C15.3124 47.9342 16.0857 48.7002 16.8825 48.9113C17.1481 48.9816 19.3118 48.9973 25.7251 48.9816C34.1615 48.9582 34.2162 48.9582 34.4271 48.794C34.8411 48.4892 34.9661 48.239 34.9661 47.7466C34.9661 47.2541 34.8411 47.004 34.4271 46.6991C34.2162 46.535 34.1615 46.535 25.8579 46.5115L17.5074 46.4959V35.2397V23.9835H22.5067H27.4983L27.5217 27.3369C27.5451 30.5887 27.553 30.6982 27.7092 30.9092C27.9513 31.2375 28.2326 31.4173 28.5763 31.4642C28.834 31.4955 29.2324 31.3939 30.701 30.9014L32.5054 30.2995L34.3099 30.9014C35.7784 31.3939 36.1768 31.4955 36.4346 31.4642C36.7783 31.4173 37.0595 31.2375 37.3017 30.9092C37.4579 30.6982 37.4657 30.5887 37.4892 27.3369L37.5126 23.9835H42.5041H47.5035L47.5191 28.5876C47.5425 33.1057 47.5425 33.1995 47.7066 33.4106C48.0112 33.8249 48.2612 33.9499 48.7533 33.9499C49.2454 33.9499 49.4954 33.8249 49.8001 33.4106C49.9641 33.1995 49.9641 33.1057 49.9875 27.9466C50.0032 24.1868 49.9875 22.6078 49.9172 22.3811C49.8079 21.9824 44.7304 14.3923 44.4336 14.1735C44.2148 14.0171 44.1524 14.0171 32.5992 14.0015C25.0455 13.9937 20.9132 14.0171 20.7882 14.064ZM28.4825 16.7295C28.4591 16.8702 28.2716 17.988 28.0685 19.2153L27.6936 21.4431L23.1473 21.4665L18.601 21.4822L20.257 18.9808L21.9209 16.4872L25.2251 16.4794H28.5294L28.4825 16.7295ZM34.3177 18.7463C34.5208 19.9735 34.7083 21.0913 34.7317 21.2242L34.7786 21.4822H32.5054H30.2245L30.2714 21.2633C30.2948 21.146 30.4745 20.0673 30.6775 18.8635C30.8728 17.6597 31.0447 16.6279 31.0603 16.5732C31.0916 16.495 31.4196 16.4794 32.5211 16.495L33.9427 16.5185L34.3177 18.7463ZM44.7538 18.9808L46.4099 21.4822L41.8636 21.4665L37.3173 21.4431L36.9424 19.2153C36.7393 17.988 36.5518 16.8702 36.5283 16.7295L36.4815 16.4794H39.7857L43.09 16.4872L44.7538 18.9808ZM35.0051 26.2426V28.5095L33.8568 28.1186C33.2241 27.9076 32.6148 27.7356 32.5054 27.7356C32.3961 27.7356 31.7868 27.9076 31.154 28.1186L30.0058 28.5095V26.2426V23.9835H32.5054H35.0051V26.2426Z"
                                                fill="#ED790E" />
                                            <path
                                                d="M44.7675 36.6153C42.8224 36.9671 40.9086 38.0458 39.6744 39.4841C36.7763 42.8531 36.7763 47.637 39.6744 51.006C41.2601 52.8508 43.7832 53.9998 46.2517 53.9998C51.0479 53.9998 55.0005 50.0445 55.0005 45.245C55.0005 41.0005 51.9072 37.3423 47.6968 36.6153C46.8531 36.4668 45.5721 36.4668 44.7675 36.6153ZM47.8765 39.2261C50.0715 39.8436 51.7041 41.5164 52.3134 43.7598C52.5243 44.5337 52.5087 46.0345 52.2821 46.8318C51.6416 49.0674 49.9934 50.6933 47.7358 51.3109C47.0328 51.5063 45.4705 51.5063 44.7675 51.3109C43.6583 51.0138 42.7599 50.5057 41.971 49.7475C41.0961 48.9111 40.5571 48.0122 40.2212 46.8318C39.9947 46.0345 39.979 44.5337 40.19 43.7598C40.4868 42.6499 40.9945 41.7509 41.7523 40.9614C42.7365 39.9374 43.8692 39.3277 45.2987 39.0698C45.8845 38.9603 47.2359 39.0463 47.8765 39.2261Z"
                                                fill="#ED790E" />
                                            <path
                                                d="M45.7457 41.6033C45.4566 41.7362 45.1989 42.0098 45.0895 42.299C44.9567 42.6429 44.9801 45.4257 45.1129 45.7384C45.1754 45.8791 45.8863 46.6451 46.6909 47.4503C48.2766 49.0214 48.386 49.084 49.0421 48.9589C49.4249 48.8885 49.8936 48.4195 49.9639 48.0365C50.0889 47.3955 50.0029 47.2548 48.714 45.9494L47.5111 44.7378L47.4876 43.5106C47.4642 42.1817 47.4251 42.0723 46.9408 41.7049C46.6752 41.5095 46.0581 41.4548 45.7457 41.6033Z"
                                                fill="#ED790E" />
                                        </g>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_1953_6020">
                                            <rect width="57.92" height="57.92" fill="white"
                                                transform="translate(0.869995 0.0351562)" />
                                        </clipPath>
                                    </defs>
                                </svg>
                                <div class="text-end">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img class="bg-soft-primary rounded img-fluid avatar-80 me-3"
                                                            src="{{ Storage::url($item->fotomakanan) }}"
                                                            alt="profile">
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-capitalize">
                                            <p class="mb-0">nama pembeli : {{ $User->user->name }}</p>
                                            <p class="">Harga : Rp. {{ number_format($User->totalharga) }}</p>
                                        </div>
                                    </div>
                                </div>
                            @empty
            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12">
                    <div class="card overflow-hidden" data-aos="fade-up" data-aos-delay="600" data-iq-gsap="onStart"
                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="header-title">
                                <h4 class="card-title">Menu Rating tertinggi</h4>
                            </div>
                        </div>
                        <div class="card-body py-0">
                            <div class="table-responsive">
