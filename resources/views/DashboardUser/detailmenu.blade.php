                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-xl-5 mb-4 mt-xl-0 text-center">
                            <img src="{{asset('Storage/' . $p->fotomakanan)}}" class="img-fluid avatar-170 blur-shadow position-bottom" alt="profile-image">
                            <img src="{{asset('Storage/' . $p->fotomakanan)}}" class="img-fluid avatar-170 hover-image" alt="profile-image" data-iq-gsap="onStart" data-iq-opacity="0" data-iq-scale=".6" data-iq-rotate="180" data-iq-duration="1" data-iq-delay=".6" data-iq-trigger="scroll" data-iq-ease="none">                            <h5 class="mt-3 mb-2">Nama Menu: {{ $p->namamenu }}</h5>
