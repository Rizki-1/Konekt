                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between ">
                        <div class=""><img src="{{ asset('assets/img/poto.png') }}" width="100px"
                                alt="" srcset=""></div>
                        <div class="text-bold px-4">
                            <h5 class="form-label">Jumlah Menu</h5>
                            <div class="">
                                <p class="form-label">{{ session('jumlahpembelian') }}</p>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <div class="mt-2">
                            <p class="text-bold">Dana yang di ajukkan</p>
                        </div>
                        <div class="mt-2">
                            <p class="form-label">Rp.15,000</p>
                        </div>
                    </div>
                    <hr>
