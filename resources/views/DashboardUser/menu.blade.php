            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="d-flex flex-wrap flex-row justify-content: flex-end"  >
                        <a href="{{ route('kategorifilter', ['kategori' => $Kategori->id]) }}" class="btn btn-warning" style="display: flex; width: auto; margin-top: 1rem; ms-5; text-align: right;">  {{ $Kategori->kategori }} </a>
                    </div>
                    @endforeach
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var resultsContainer = $(
                                ".row-cols-1.row-cols-md-2.row-cols-xl-4.row-cols-xxl-4");
                            resultsContainer
                                    ...
                                    var menuItem = `
                                                <div class="col-xl-3 col-lg-3 col-md-6 col-12 dish-card-horizontal mt-2">
                                                    ...
                                                    <div class="card-body menu-image">
                                                        ...
                                                        <div class="d-flex justify-content-center gap-2 mt-3">
                                                            <button class="btn btn-primary" data-bs-toggle="modal"
                                                                data-bs-target="#myModal-${menu.id}"><i class="bi bi-bag-check"></i> Beli
                                                            </button>
                                                            <a class="btn btn-primary" href="{{ route('detailmenu', ['id' => '/']) }}/${menu.id}">Detail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
