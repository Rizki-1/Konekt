                        ...
                        <div class="swiper-wrapper">
                         ...
                         data-iq-ease="none">
                            <div class="card-profile-progress mb-3">
                                <div id="circle-progress-1" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="65" data-type="percent"></div>
                                <img src="../assets/images/layouts/13.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image">
                            </div>
                            <div class="text-center">
                                <p class="mb-2">65%</p>
                                <h6 class="heading-title fw-bolder">Mix Vaggie Pizza</h6>
                            </div>                        </div>
                            <div class="swiper-slide text-center" data-iq-gsap="onStart"
                         data-iq-opacity="0"
                         data-iq-position-y="-40"
                         data-iq-duration=".6"
                         data-iq-delay=".5"
                         ...
                         data-iq-ease="none">
                            <div class="card-profile-progress mb-3">
                                <div id="circle-progress-2" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="50" data-type="percent"></div>
                                <img src="../assets/images/layouts/11.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image">
                            </div>
                            <div class="text-center">
                                <p class="mb-2">50%</p>
                         ...
                         data-iq-ease="none">
                            <div class="card-profile-progress mb-3">
                                <div id="circle-progress-3" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="55" data-type="percent"></div>
                                <img src="../assets/images/layouts/12.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image">
                            </div>
                            <div class="text-center">
                                <p class="mb-2">55%</p>
                         ...
                         data-iq-ease="none">
                                <div class="card-profile-progress mb-3">
                                    <div id="circle-progress-4" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="55" data-type="percent"></div>
                                    <img src="../assets/images/layouts/10.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image">
                                </div>
                                <div class="text-center">
                                    <p class="mb-2">55%</p>
                         ...
                         data-iq-ease="none">
                                <div class="card-profile-progress mb-3">
                                    <div id="circle-progress-5" class="circle-progress  circle-progress-basic circle-progress-primary" data-min-value="0" data-max-value="100" data-value="65" data-type="percent"></div>
                                    <img src="../assets/images/layouts/13.png" class="img-fluid  rounded-circle card-img circle-image rotete-infinite" alt="image">
                                </div>
                                <div class="text-center">
                                    <p class="mb-2">65%</p>
            ...
            <div class="card card-primary"  data-iq-gsap="onStart"
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div class="col">
                        ...
                        <h2 class="text-white mb-4">$ 4,585,963 </h2>
                    ...
                    <div class="col-2  card mb-0 bg-white card-body">
                        ...
                        <div class=" text-center">
                            ...
                            <h6 class="heading-title text-primary text-center mt-3">+0.4% <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.77083 3.54199L9.77083 16.042" stroke="#EA6A12" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M4.75213 8.58301L9.77213 3.54134L14.793 8.58301" stroke="#EA6A12" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </h6>
            ...
            <div class="card"  data-iq-gsap="onStart"
                 ...
                 <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                     ...
                     <div class="dropdown float-end">
                         ...
                         <ul class="dropdown-menu dropdown-menu-end rounded" aria-labelledby="dropdownMenuButton23">
                ...
                <div class="card-body">
                    ...
                    <div class="row row-cols-md-12 row-cols-lg-3 g-3 g-lg-3 ">
                        <div class="col">
                            <div class="card  bg-soft-primary menu-card mb-lg-0" data-iq-gsap="onStart"
                      data-iq-opacity="0"
                      data-iq-position-y="-40"
                      data-iq-duration=".6"
                      data-iq-delay="1"
                      ...
                      data-iq-ease="none">
                                <div class="card-body">
                                    <img src="../assets/images/layouts/6.png" class="avatar-45 img-fluid mb-3" alt="img">
                         ...
                         <div class="col">
                            <div class="card  bg-soft-primary mb-0 menu-card-2 mb-lg-0" data-iq-gsap="onStart"
                      data-iq-opacity="0"
                      data-iq-position-y="-40"
                      data-iq-duration=".6"
                      data-iq-delay="1"
                      ...
                      data-iq-ease="none">
                                <div class="card-body">
                                    <img src="../assets/images/layouts/7.png" class="avatar-45 img-fluid mb-3" alt="img">
                         ...
                         <div class="col">
                            <div class="card col bg-soft-primary mb-0 menu-card-3 mb-lg-0" data-iq-gsap="onStart"
                      data-iq-opacity="0"
                      data-iq-position-y="-40"
                      data-iq-duration=".6"
                      data-iq-delay="1"
                      ...
                      data-iq-ease="none">
                                <div class="card-body">
                                    <img src="../assets/images/layouts/39.png" class="avatar-45 img-fluid mb-3" alt="img">
...
<!-- Mirrored from templates.iqonic.design/aprycot/html/dashboard/dist/dashboard/admin-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2023 04:53:39 GMT -->
</html>
