...
<body
    class=""style="background:url(../../assets/images/dashboard.png);    background-attachment: fixed; background-size: cover;">
                ...
                <div class="card-body">
                    <div class="" data-iq-gsap="onStart" data-iq-opacity="0" data-iq-position-y="-40"
                        ...
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#myModal">Tambah Kategori</button>
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(error) {
                            Swal.fire('Peringatan', error.responseJSON.message,
                                'warning');
                        }
                    });
                }
