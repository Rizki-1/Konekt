                        ...
                        <a class="nav-link "  href="DashboardPenjual_" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="{{ route('DashboardPenjual.index') }}" >
                                  ...
                                  <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="28" viewBox="0 0 20 19" fill="none">
