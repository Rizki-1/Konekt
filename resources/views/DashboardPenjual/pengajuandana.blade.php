                        ...
                        <a class="nav-link "  href="DashboardPenjual_" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="pengajuandana">
                                   <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" viewBox="0 0 21 22" fill="none">
