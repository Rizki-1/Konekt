    ...
    <div class="content-inner mt-5 py-0">
        ...
        @foreach ($penjual as $p)
                ...
                <div class="card-body menu-image">
                    <h6 class="heading-title fw-bolder mt-3 mb-0 text-center fs-5">{{ $p->namamenu }}</h6>
                    <h6 class="text-center  fw-light mt-1">{{ $p->adminkategori->kategori }}</6>
                    <h6 class="heading-title fw-bolder mt-2 mb-0 text-center">{{ $p->toko_id }}</h6>
                    <div class="d-flex justify-content-evenly">
                        <span class="text-primary fw-bolder mt-2">Rp. {{ number_format($p->harga) }}</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-evenly mt-3">
                        <a class="btn btn-outline-info" href="{{ route('detailmenupen', ['id' => $p->id]) }}"><i class="bi bi-eye"></i></a>
